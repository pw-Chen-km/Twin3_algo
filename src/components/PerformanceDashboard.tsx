      ...
      {performanceMetrics ? (
        <div className="space-y-4">
          ...
          {processingTimeData.length > 0 && (
            <div>
              <h4 className="text-sm font-medium mb-2">Processing Time Trend</h4>
              <div className="h-24">
          ...
          {dimensionDistribution.some(d => d.value > 0) && (
            <div>
              <h4 className="text-sm font-medium mb-2">Active Dimensions</h4>
              <div className="h-24">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
        ...
        <div className="text-center py-8 text-muted-foreground">
          ...
          <p className="text-xs">Process some content to see metrics</p>
        </div>
      )}
    </div>
  );
